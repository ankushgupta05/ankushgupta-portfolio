                ...
                <div className='md:w-[70%] p-11 flex flex-col space-y-12' >
                  ...
                  <div className='w-full md:flex md:flex-row md:justify-around'>
                    <div className="flex space-x-4  justify-around">
                      ...
                      <a href="https://www.linkedin.com/in/ankush-gupta-b734b025b/" target='_blank' className="text-2xl"><i className="fab fa-github"> <Image src={instagram} alt={'development'} width={40} height={40} className="mx-auto mb-2 bg-white rounded-lg " /> </i></a>
                      ...
                      <a href="https://www.linkedin.com/in/ankush-gupta-b734b025b/" target='_blank' className="text-2xl"><i className="fab fa-twitter"> <Image src={likedin} alt={'development'} width={40} height={40} className="mx-auto  bg-white rounded-lg  mb-2" /> </i></a>
                      <a href="https://x.com/ankushgupta0510" target='_blank' className="text-2xl"><i className="fab fa-linkedin"> <Image src={twitter} alt={'development'} width={40} height={40} className="mx-auto  bg-white rounded-lg  mb-2" /> </i></a>
                    </div>
                    ...
                    <div className='md:mt-0 mt-2'>
                      ...
                      <a href="/Documents/ankushgupta.pdf" download target='_blank' rel="noopener noreferrer">  <button className="bg-blue-500 text-white font-bold py-2 w-full md:w-36 rounded-lg ">Hire Me</button></a>
                    </div>
                  </div>
                </div>
